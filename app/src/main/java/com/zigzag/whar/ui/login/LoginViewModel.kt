...
import com.zigzag.whar.mviarch.BaseViewModel
...
class LoginViewModel @Inject constructor(private val actionProcessorHolder: LoginActionProcessorHolder) : BaseViewModel<LoginIntent, LoginViewState>() {
