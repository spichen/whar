...
import com.salah.geohash.util.Base32Utils;
import com.salah.geohash.util.GeoUtils;
...
public class GeoHash {
    ...
    public GeoHash(GeoPoint location) {
        this(location.getLatitude(), location.getLongitude(), DEFAULT_PRECISION);
    }
